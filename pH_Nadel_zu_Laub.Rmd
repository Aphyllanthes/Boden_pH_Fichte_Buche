...
```{r varianzanalyse, fig.cap="Die kumulative Dichteverteilung des pH-Wertes (links) und ein Boxplot der beiden Klassen 'Nadelbaum' und 'Laubbaum' (rechts).\\label{aov}"}
...
boxplot(data1$pH[which(data1$Anteil_Nadelbaum > 0)], data1$pH[which(data1$Anteil_Nadelbaum <= 0)], ylab="pH-Wert", names=c("Nadelbaum","Laubbaum"))
```
