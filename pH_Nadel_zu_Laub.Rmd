...
Für die Probepunkte wird die 50 x 40 m große Fläche in Quadrate von 10 x 10 m eingeteilt, worein jeweils drei zufällige Probepunkte gelegt werden. Um die Position der Punkte zu wählen werden mit der Software R [@R] 60 zufällige Winkel und Entfernungen gezogen. So werden der Reihe nach vom Mittelpunkt jedes Quadrates aus, jeweils drei Positionen für die Probenahme bestimmt. Die Probepunkte sind somit zufällig auf der Fläche verteilt, und ihre Entfernung zueinander deckt ein breites Spektrum an Distanzen ab ("nested sampling"). Dies ist Grundbedingung für die (geo)statistische Ausertung, da die räumliche Skala der Variation des pH-Wertes (noch) unbekannt ist [@geostat].  
